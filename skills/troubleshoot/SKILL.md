...
name: troubleshoot
description: >
  Error analysis and debugging skill. Triggered by /dev troubleshoot or natural language:
  "에러 고쳐줘", "에러 원인 분석해줘", "버그 원인이 뭐야", "오류가 왜 나지",
  "왜 에러가 나지", "이 에러 뭔지", "에러 원인을 분석해줘", "어디서 실패하는 거야",
  "스택트레이스 분석해줘", "디버깅 해줘", error logs, stack traces,
  Sentry alerts, GitHub Actions failure output.
