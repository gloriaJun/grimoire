...
name: refactor
description: >
  Code refactoring skill. Triggered by /dev refactor or natural language:
  "리팩토링 해줘", "코드 정리해줘", "클린 아키텍처 적용해줘", "중복 코드 정리해줘",
  "타입 추가해줘", "코드 냄새 제거해줘", "성능 개선해줘", "refactor this",
  "clean up this code". Analyzes code, proposes improvements with before/after
  diffs, and implements only after explicit user approval.
