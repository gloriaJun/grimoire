...
2. **Codex cross-review**: After user approval, request Codex review.
   ...
   - Via Codex CLI: `codex exec -c model_reasoning_effort="low" --read <features-path> "Review this feature breakdown: identify missing features, items too large for a single session, and dependency ordering issues"`
