...
4. **Codex cross-review**: After user approval, request Codex review.
   ...
   - Via Codex CLI: `codex exec -c model_reasoning_effort="low" --read <PRD-path> "Review this PRD: identify missing requirements, ambiguous items, and feasibility concerns"`
...
**Confirm with user before proceeding to Design.**
