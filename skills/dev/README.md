...
- **Utility tools** — test, refactor, troubleshoot, review, retro, til, devlog-note, setup (devlog optional)
...
Task state is tracked in a memory file under `~/.claude/projects/<project-id>/memory/`.
Artifacts (PRD, architecture.md, history.md, etc.) are stored in the devlogs folder.
